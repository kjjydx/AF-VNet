...
from config.paths import ( train_images_folder, train_labels_folder, train_prediction_folder,
                           ...
                           test_images_folder, test_labels_folder, test_images, test_prediction_folder,test_labels)
...
def run(logs_dir="logs/lightmunet/test", write_out=False, plot_conf=False):
    ##########################
    # Config
    ##########################
    ...
    img_names = [i for i in os.listdir(os.path.join(logs_dir)) if i.endswith(".pht")]
    print(len(img_names))
    ...
    for i in img_names:
        print(i)
        path_net = os.path.join(logs_dir, i)
    #path_net = os.path.join(logs_dir,"model_epoch_0480.pht")
